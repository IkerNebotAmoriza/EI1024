...
public class MiHebraFuncionSencillaBloques extends Thread{
    double [] vectorX, vectorY;
    int miId, n, nHebras, tam, ini, fin;

    public MiHebraFuncionSencillaBloques(int miId, int n, int nHebras, double [] vectorX, double [] vectorY) {
        this.miId = miId;
        this.n = n;
