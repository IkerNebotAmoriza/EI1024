            ...
            public void actionPerformed(ActionEvent e) {
                if (txfNumero.getText().trim().length() == 0) {
                    ...
                    try {
                        ...
                        MiHebraPrimoSencillo h = new MiHebraPrimoSencillo(numero);  //CREAMOS LA HEBRA AL PULSAR
                        h.setDaemon(true);  //LAS CONFIGURAMOS COMO DAEMON
                        h.start();  //INICIAMOS LA HEBRAS
