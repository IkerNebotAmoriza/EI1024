...
// ============================================================================
class CopiaVolatileCuentaIncrementos1a {
// ============================================================================
...
// ============================================================================
class CopiaVolatileMiHebra1a extends Thread {
// ============================================================================
  volatile int                  tope;
  volatile CopiaVolatileCuentaIncrementos1a c;

  // --------------------------------------------------------------------------
  public CopiaVolatileMiHebra1a(int tope, CopiaVolatileCuentaIncrementos1a c ) {
    this.tope  = tope;
    this.c     = c;
  }
...
// ============================================================================
class CopiaVolatileEjemploCuentaIncrementos1a {
// ============================================================================
  ...
  public static void main( String args[] ) {
    ...
    CopiaVolatileMiHebra1a v[] = new CopiaVolatileMiHebra1a[ numHebras ];
    CopiaVolatileCuentaIncrementos1a c = new CopiaVolatileCuentaIncrementos1a();
    t1 = System.nanoTime();
    System.out.println( "Creando y arrancando " + numHebras + " hebras." );
    for( int i = 0; i < numHebras; i++ ) {
      v[ i ] = new CopiaVolatileMiHebra1a( tope, c );
      v[ i ].start();
    }
    for( int i = 0; i < numHebras; i++ ) {
      try {
