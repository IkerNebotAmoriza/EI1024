...
public class MiHebra_6 extends Thread{
    ...
    public MiHebra_6(int miId, int numHebras, Vector<String> vectorLineas, ConcurrentHashMap<String, AtomicInteger> chmCuentaPalabrasAtomic) {
        this.miId = miId;
    ...
    private static void contabilizaPalabra6(ConcurrentHashMap<String,AtomicInteger> cuentaPalabras, String palabra ) {
        ...
        for( int i = miId; i < vectorLineas.size(); i += numHebras ) {
            ...
            for( int j = 0; j < palabras.length; j++ ) {
                ...
                if( palabraActual.length() > 0 ) {
                    contabilizaPalabra6( chmCuentaPalabrasAtomic, palabraActual );
                }
            }
        }
    }
